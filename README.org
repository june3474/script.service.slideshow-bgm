...
In most cases, this happens due to corrupted or abnormally encoded audio files. They seem to fail SeekTime function of kodi which use ffmpeg/libav internally; and SeekTime() ends up on time 0, the beginning of the file. Take a look at the example below:
